...
class AsignaturaCursada(models.Model):
    ...
    estado = models.CharField(max_length=30, blank=True, null=True, db_comment='aprobado/repro/cursando')
    created = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    modified = models.DateTimeField(auto_now=True, blank=True, null=True)
...
class EducacionPrimaria(models.Model):
    id = models.SmallAutoField(primary_key=True)
    id_estudiante = models.OneToOneField('Estudiante', models.DO_NOTHING, db_column='id_estudiante')
...
class InscripcionEstudiante(models.Model):
    ...
    anio_cursando = models.CharField(max_length=30, blank=True, null=True)
    estado = models.CharField(max_length=20, blank=True, null=True, db_comment='si/no')
    fecha_inscripcion = models.DateField(blank=True, null=True)
    descripccion = models.CharField(max_length=150, blank=True, null=True)
    created = models.DateTimeField(auto_now_add=True, blank=True, null=True)
    modified = models.DateTimeField(auto_now=True, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'inscripcion_estudiante'
